...
JNIEXPORT void JNICALL Java_core_LuckyProfiler_1_computeAngs(JNIEnv* env, jobject, jintArray locx, jintArray locy, jintArray SkelImwithout1, jint SkelNum, jint imgH, jint imgW) {
...
JNIEXPORT JNIEXPORT jintArray JNICALL Java_core_LuckyProfiler_1_getSkeleton(JNIEnv *env, jobject, jintArray JSkeletontemp, jint imgH, jint imgW) {
...
JNIEXPORT void JNICALL Java_core_LuckyProfiler_1_computeRCadiAndRelatedLocIndex
...
JNIEXPORT jintArray JNICALL Java_core_LuckyProfiler_1_getRCadi(JNIEnv* env, jobject) {
	jintArray result = NULL;
...
JNIEXPORT jintArray JNICALL Java_core_LuckyProfiler_1_getRelatedLocIndex(JNIEnv* env, jobject) {
	jintArray result = NULL;
	result = env->NewIntArray(skelNum * PreProjectionNum);
...
JNIEXPORT jdoubleArray JNICALL Java_core_LuckyProfiler_1_getAngs(JNIEnv* env, jobject) {
